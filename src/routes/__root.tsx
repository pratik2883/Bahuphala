    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-navy px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-navy-deep"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "Expert structural engineering & analysis services. Precise 2D/3D CAD drafting, FEA, and CFD solutions delivered on time.",
      },
